...
public class Main {
    public static void main(String[] args) {
        ...
        rentalSystem.addCar(new Car("C001", "Toyota", "Fortuner", 1000));
        rentalSystem.addCar(new Car("C002", "Honda", "Civic", 800));
        rentalSystem.addCar(new Car("C003", "Ford", "Mustang", 1200));
